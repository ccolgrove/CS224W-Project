...
Using all of the levels as features typically resulted in f-scores between the single level f-scores. Combining the out-links and in-links at that point in some cases even further decreased the f-score. This shows the troubles involved with dumping many features together and speaks for the benefits of the feature selection we performed. 
